...
class PlanningGraph():
        ...
        for action in self.all_actions:
            if PgNode_a(action).prenodes.issubset(self.s_levels[level]):
                for s_node in self.s_levels[level]:
                    s_node.children.add(PgNode_a(action))
                    PgNode_a(action).parents.add(s_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # If class intersections representing non-sequitur wrt consistency,
        # such as adding and removing idential actions, exist flag as true
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # If class intersections representing interference, such as removal
        # of a precondition, exist flag as true
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        # Flag as true if the same symbol has differing is_pos data members
        # enconded on different nodes
