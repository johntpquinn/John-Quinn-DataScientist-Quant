...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            ...
            for pre_condition_neg in action.precond_neg:
                if pre_condition_neg in kb.clauses:
                    is_possible = False
                    break 
            
            for pre_condition_pos in action.precond_pos:
                if pre_condition_pos not in kb.clauses:
                    is_possible = False
                    break 
